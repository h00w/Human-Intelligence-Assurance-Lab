...
from hia.review_execution import REVIEWER_FIELDS, csv_bytes, make_reviewer_sheet, validate_frozen_queue
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create blinded independent reviewer sheets from the frozen semantic review queue.")
    parser.add_argument("--input", type=Path, default=DEFAULT_INPUT)
    parser.add_argument("--out", type=Path, default=DEFAULT_OUT)
    parser.add_argument("--reviewers", nargs="+", required=True, help="Opaque reviewer IDs, e.g. reviewer_A reviewer_B")
